 ...
 */
export const LocalDateRangeFactory = Factory.define<{start: LocalDate, end: LocalDate}, DateRangeFactoryTransientParams>(
...
export const LocalTimeRangeFactory = Factory.define<{start: LocalTime, end: LocalTime}, TimeRangeFactoryTransientParams>(
  ({ sequence, transientParams }) => {
