...
import {
  ExampleHelper,
  type IExampleHelper,
} from "../../helpers/example_helper.ts";
...
describe("ExampleHelper", () => {
  ...
  describe("calculatePriority", () => {
    it("should return high priority for urgent tags", () => {
      ...
      expect(helper.calculatePriority(["other", "urgent", "more"])).toBe(
        "high",
      );
    });
    ...
    it("should return medium priority for important tags", () => {
      ...
      expect(helper.calculatePriority(["important", "enhancement"])).toBe(
        "medium",
      );
    ...
    it("should return medium priority for feature tags", () => {
      ...
      expect(helper.calculatePriority(["enhancement", "feature"])).toBe(
        "medium",
      );
    });
