        ...
        try {
            ...
            if (emittedEvents.length > 0) {
                ...
                if (pongEvents.length > 0) {
                    setRealPongEvents(prev => [
                        ...pongEvents,
                        ...prev.slice(0, 9 - pongEvents.length),
                    ])
                }
            }
        } catch (err) {
    ...
    return (
        <div className={styles.section}>
            ...
            <div className={styles.grid}>
                <div>
                    <label className={styles.label}>Ping Message</label>
                    <input
                        type="text"
                ...
                <div className={styles.responseBox}>
                    ...
                    <div className={styles.responseContent}>
                        <div>
                            ...
                            {realPingResponse.success ? 'Success' : 'Failed'}
                        </div>
                        <div>
                            <strong>Message:</strong> {realPingResponse.message}
                        </div>
                        <div>
                            <strong>Event ID:</strong> {realPingResponse.pingEvent.id}
                        </div>
                        <div>
                    ...
                    <div className={styles.pongEventsList}>
                        {realPongEvents.map(pongEvent => (
                            <div key={pongEvent.id} className={styles.pongEvent}>
                                <div className={styles.pongEventMessage}>
                                    {pongEvent.payload.reply}
                                </div>
                                <div className={styles.pongEventMeta}>
                                    <span className={styles.pongEventTag}>
                                        ID: {pongEvent.id.slice(0, 8)}...
                                    </span>
                                    {pongEvent.correlationId && (
                                        <span className={styles.pongEventTag}>
                                            Corr: {pongEvent.correlationId.slice(0, 8)}...
                                        </span>
                                    )}
                                    <span className={styles.pongEventTag}>
                                        {new Date(pongEvent.timestamp).toLocaleTimeString()}
                                    </span>
                                </div>
                            </div>
                        ))}
    ...
    return (
        <div className={styles.page}>
            <div className={styles.container}>
                <div>
                    <h1 className={styles.title}>🎯 Example API Test Center</h1>
                    ...
                    <div className={styles.section}>
                        ...
                        <div className={styles.infoBox}>
                            <p className={styles.infoText}>
                                <strong className={styles.infoTextStrong}>Endpoint Tester:</strong>{' '}
                                Use the endpoint tester to try all Example Management tRPC API
                                endpoints with dropdown selection, code generation, and response
                                inspection. Perfect for testing example endpoints with both cURL and
                                tRPC client modes.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={styles.infoBox}>
                        ...
                        >
                            <div>
                                ...
                                <span style={{ color: '#3b82f6' }}>{apiUrl}</span>
                            </div>
                            <div>
                                <strong>tRPC Path:</strong>{' '}
                                <span style={{ color: '#10b981' }}>{trpcBasePath}</span>
                            </div>
                            <div>
                                <strong>Full tRPC URL:</strong>{' '}
                        ...
                        <p className={styles.infoText}>
                            💡 <strong>Tip:</strong> Use the <strong>🔗</strong> button in the
                            top-right corner to edit API configuration.
                        </p>
                    </div>
                </div>
                ...
                <div className={styles.section}>
                    <h2 className={styles.sectionTitle}>🎯 Example API Testing Demo</h2>
                    <div className={styles.infoBox}>
                        <p className={styles.infoText}>
                            <strong className={styles.infoTextStrong}>Example API Demo:</strong>{' '}
                            This section demonstrates the Example Management API connectivity. When
                            you test the API, it checks the health endpoint and shows the connection
                            status that gets displayed in the events section below.
                        </p>
                    </div>
                    <RealPingPongSection />
                </div>
                    ...
                    <div className={styles.terminalBox}>
                        {eventHistory.length === 0 ? (
                            <div className={styles.terminalEmpty}>
                                No events yet. Test the API to see the live stream!
                            </div>
                        ) : (
                            eventHistory.map(event => (
                                <div key={event.id} className={styles.terminalEvent}>
                                    ...
                                    <span
                                        className={`${styles.terminalId} ${event.type === 'ping' ? styles.terminalPing : styles.terminalPong}`}
                                    >
                                        {event.type === 'ping' ? '📤' : '📥'}{' '}
                    ...
                    <div className={styles.statsGrid}>
                        ...
                        <div className={`${styles.statCard} ${styles.statCardPurple}`}>
                            <div className={`${styles.statValue} ${styles.statValuePurple}`}>
                                {performanceStats.pongEvents}
                            </div>
                            <div className={`${styles.statLabel} ${styles.statLabelPurple}`}>
                                Responses
                            </div>
                        </div>
                        <div className={`${styles.statCard} ${styles.statCardYellow}`}>
                            ...
                            <div className={`${styles.statLabel} ${styles.statLabelYellow}`}>
                                Avg Response
                            </div>
                        </div>
                        <div className={`${styles.statCard} ${styles.statCardEmerald}`}>
                            ...
                            <div className={`${styles.statLabel} ${styles.statLabelEmerald}`}>
                                Success Rate
                            </div>
                        </div>
                        <div className={`${styles.statCard} ${styles.statCardGray}`}>
                            ...
                            <div className={`${styles.statLabel} ${styles.statLabelGray}`}>
                                Last Activity
                            </div>
                        </div>
                    </div>
