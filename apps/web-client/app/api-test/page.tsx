...
export default function ApiTestPage() {
    ...
    const [curlService, setCurlService] = useState<TrpcCurlService>(
        () => new TrpcCurlService(apiUrl, trpcBasePath)
    )
    const [trpcService, setTrpcService] = useState<TrpcClientService>(
        () => new TrpcClientService(apiUrl, trpcBasePath)
    )
            ...
            <div className={styles.container}>
                <header>
                    ...
                    <p className={styles.subtitle}>
                        Interactive endpoint testing with dropdown selection, code generation, and
                        response inspection
                    </p>
                </header>
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.infoBox}>
                        ...
                        <p className={styles.infoText} style={{ marginTop: '0.75rem' }}>
                            ...
                            top-right corner to edit API configuration from any page.
                        </p>
                    </div>
                </div>
                    ...
                    {selectedEndpoint ? (
                        <div className={styles.responseBox}>
                            ...
                            <div className={styles.responseContent}>
                                <div>
                                    <strong>Name:</strong> {selectedEndpoint.name}
                                </div>
                                <div>
                                ...
                                <div>
                                    <strong>URL:</strong>{' '}
                                    <code className={styles.codeBlock}>{selectedEndpoint.url}</code>
                                </div>
                        ...
                        <div className={styles.infoBox}>
                            <p className={styles.infoText}>
                                ...
                                Choose an endpoint from the dropdown above to see its details, input
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.formGroup}>
                        <label className={styles.label}>
                            {selectedEndpoint
                                ? 'JSON Input Data'
                                : 'Select an endpoint to enable input'}
                        </label>
                        <textarea
                            value={inputData}
                    ...
                    {selectedEndpoint ? (
                        ...
                        <div className={styles.infoBox}>
                            <p className={styles.infoText}>
                                ...
                                Select an endpoint to see the generated code examples.
                            </p>
                        </div>
                    )}
                </div>
