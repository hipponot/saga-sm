...
export function GlobalUrlEditor() {
    const { apiUrl, trpcBasePath, setApiUrl, setTrpcBasePath, isDefault, resetToDefault } =
        useApiUrl()
                ...
                <div className="url-display-panel">
                    <div className="panel-header">
                        <span className="panel-title">
                            API Config {!isDefault && <span className="custom-badge">Custom</span>}
                        </span>
                        <button
                    ...
                    <div className="url-display">
                        <div className="url-row">
                            ...
                            <span className="url-value api-url" title={apiUrl}>
                                {truncateUrl(apiUrl)}
                            </span>
                        </div>
                        <div className="url-row">
                            <span className="url-label">Path:</span>
                            <span className="url-value path-url" title={trpcBasePath}>
                                {trpcBasePath}
                            </span>
                        </div>
                    </div>
